...
export default function PixelCard({ variant = 'default', gap, speed, colors, noFocus, className = '', children }: PixelCardProps) {
    ...
    return (
        <div
            ref={containerRef}
            className={`h-[400px] w-[300px] relative overflow-hidden grid place-items-center aspect-[4/5] border border-white/10 rounded-[25px] isolate transition-colors duration-200 ease-[cubic-bezier(0.5,1,0.89,1)] select-none bg-black/20 ${className}`}
        ...
        >
            <canvas className="absolute inset-0 w-full h-full block z-0" ref={canvasRef} />
